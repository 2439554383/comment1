...
class OldHttpUtil {
  static final OldHttpUtil _instance = OldHttpUtil._internal();
  factory OldHttpUtil() => _instance;
   ...
   * 取消请求
   *
   * 同一个cancel token 可以用���多个请求，当一个cancel token取消时���所有使用该cancel token的请求都会被取消。
   * 所以参数可选
   */
